...
readonly MAX_CHARS="${LAZY_READER_MAX_CHARS:-24000}"
...
OPENROUTER_SPEED="$(normalize_speed_alias "${LAZY_READER_OPENROUTER_SPEED:-}")"
readonly OPENROUTER_SPEED
readonly OPENROUTER_RESPONSE_FORMAT="${LAZY_READER_OPENROUTER_RESPONSE_FORMAT:-auto}"
readonly GENERATED_SPEECH_CHUNK_MAX_CHARS="${LAZY_READER_GENERATED_SPEECH_CHUNK_MAX_CHARS:-14000}"
...
readonly NARRATE_INPUT_MAX_CHARS="${LAZY_READER_NARRATE_INPUT_MAX_CHARS:-48000}"
...
readonly SUMMARIZE_MAX_CHARS="${LAZY_READER_SUMMARIZE_MAX_CHARS:-32000}"
readonly SUMMARIZE_INPUT_MAX_CHARS="${LAZY_READER_SUMMARIZE_INPUT_MAX_CHARS:-60000}"
...
readonly VISION_CMD="${LAZY_READER_VISION_CMD:-}"
readonly VISION_MAX_CHARS="${LAZY_READER_VISION_MAX_CHARS:-${MAX_CHARS}}"
